...
CREATE PROCEDURE sp_update_cliente(
    ...
    IN p_tipoImagenPerfil VARCHAR(100),
    IN p_tokenConfirmacion VARCHAR(255),
    IN p_correoVerificado BOOLEAN
)
BEGIN
    ...
    SET
        ...
        tipoImagenPerfil = p_tipoImagenPerfil,
...
(
    'Estándar',
    'Habitación estándar con las comodidades esenciales para una estadía confortable.'
);
...
(
    'Junior suite',
    'Habitación amplia con mayor comodidad, zona de descanso y servicios adicionales.'
);
...
(
    'Suite vista al mar',
    'Suite espaciosa con servicios premium y vista al mar.'
);
