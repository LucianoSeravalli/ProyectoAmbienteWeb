...
public interface ClienteRepository extends JpaRepository<Cliente, Integer> {
    ...
    void insertarCliente(
            ...
            @Param("p_imagenPerfil") byte[] imagenPerfil,
            @Param("p_tipoImagenPerfil") String tipoImagenPerfil,
    ...
    @Procedure(procedureName = "sp_update_imagen_perfil")
    void actualizarImagenPerfil(
            @Param("p_idCliente") Integer idCliente,
            @Param("p_imagenPerfil") byte[] imagenPerfil,
            @Param("p_tipoImagenPerfil") String tipoImagenPerfil
    );
